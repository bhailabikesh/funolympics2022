...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="overflow-y:scroll !important; background: #031527;">
    <!-- Brand Logo -->
    <a href="{{ url('') }}" class="brand-link">
      <img src="{{ asset('front_assets/img/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="height:45px">
      <span class="brand-text font-weight-light" style="font-size:22px">Funolympic</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{ url('admin') }}" class="nav-link active" style="background-color: #b91919;">
