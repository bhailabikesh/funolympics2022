              ...
              <form   method="post" action="{{ route('users.update',$user->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                 ...
                 <div class="form-group">
                    ...
                    <input type="password" name="confirm-password" class="form-control" id="name" placeholder="Enter the confirm password" >
                  </div>
                ...
                <label>Role:</label>
                 ...
                 <!-- <div class="form-group">
                  ...
                  <select class="form-control select2bs4" name="status" style="width: 100%;" id="status">
                    ...
                    <option value="0" @if ($user->status == '0') selected="selected" @endif>DeActive</option>  
                    </select>
                </div>-->
