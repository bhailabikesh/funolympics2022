              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('contact.show',$contact->id) }}"><button type="submit" class="btn btn-success btn-sm">View</button></a>
                    </td>
                    <td>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default" onclick="handleDelete({{ $contact->id  }})">
