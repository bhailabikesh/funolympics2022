          ...
          <div class="col-md-12">
            ...
            <div class="card card-dark">
              ...
              <!-- form start -->
                ...
                <h5><label>Date:</label> {{ $contact->created_at->translatedFormat('l j F Y') }}</h5>
                <h5><label>Full Name: </label> {{ $contact->name }}</h5>
                <h5><label>Email Adress: </label>  {{ $contact->email }}</h5>
                <h5><label>Subject: </label> {{ $contact->subject }}</h5>
              ...
              <a href="{{ route('contact.index') }}"><button type="button" class="btn btn-success">Back</button></a>
