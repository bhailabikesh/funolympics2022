...
<head>
    ...
    <title>Fun Olympics 2022 - City of Bayjing</title>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <ul class="main-menu mobile-menu">
            ...
            <li><a href="{{ url('/watch_live') }}">Live Streaming</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ht-links">
                            @auth
                            <a href="{{ url('user/dashboard') }}"><i class="fa fa-user"></i> {{ Auth::user()->name }}</a>
                            @else
